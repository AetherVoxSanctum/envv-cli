...
PROJECT             := github.com/AetherVoxSanctum/envv
...
GITHUB_REPOSITORY   ?= github.com/AetherVoxSanctum/envv
...
.PHONY: install
install:
	$(GO) install github.com/AetherVoxSanctum/envv/cmd/envv
...
functional-tests:
	$(GO) build -o functional-tests/sops github.com/AetherVoxSanctum/envv/v3/cmd/sops
